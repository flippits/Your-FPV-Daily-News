...
MAGAZINE_IMAGES = [
    ...
    (
        "https://upload.wikimedia.org/wikipedia/commons/thumb/f/fe/Remote_Control_FPV_drone_FPV_Goggles.jpg/1280px-Remote_Control_FPV_drone_FPV_Goggles.jpg",
...
def render_weekly(items: List[Item], week_start: datetime, week_end: datetime) -> str:
    ...
    lines = [
        f"# Your FPV Weekly Recap — {week_label}",
        "",
        "_The biggest FPV stories, gear drops, and videos from the week._",
        "",
        f"![FPV weekly hero]({hero_url})",
        "",
        "---",
        "",
    ]
    ...
    render_section(\"Gear & Market Watch\", gear, 6)
